           ...
           <div className="row p-5">
            ...
            <div className="col-6 p-5">
                ...
                <div className="text-center p-5">
                    <a href="" className="mx-3" style={{textDecoration:"none"}} aria-hidden="true">Explore our products <i class="fa-solid fa-arrow-right-long"></i></a>
                    <a href=""  style={{textDecoration:"none"}} aria-hidden="true">Try kite demo <i class="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
           </div>
        </div>
